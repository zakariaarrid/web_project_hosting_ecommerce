    ...
    <div id="logoAndNav" class="main-header-menu-wrap bg-transparent">
        <div class="container">
            <nav class="js-mega-menu navbar navbar-expand-md header-nav">
                ...
                <!--logo start-->
                <a class="navbar-brand" href="index.html"><img src="img/logo-white.png" width="120" alt="logo"
                                                               class="img-fluid"/></a>
                <!--logo end-->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row mega-menu-wrap">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <span class="sub-menu-title">LTR Demo</span>
                                                <ul class="sub-menu-nav-group mb-3">
                                                    <li><a class="nav-link sub-menu-nav-link"
                                                           href="https://hostlar.themetags.com/">Home Default <span class="badge badge-danger ml-2">LTR</span></a></li>
                                                </ul>
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="card login-signup-card shadow-lg mb-0">
                        ...
                        <div class="card-footer bg-transparent px-md-5"><small>Have an account ?</small>
                            <a href="{{route('loginar')}}" class="small"> Login</a></div>
                    </div>
                </div>
            </div>
        </div>
